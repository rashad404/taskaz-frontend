  ...
  return (
    <div>
      ...
      {filteredTasks.length === 0 ? (
        <div className="text-center py-16 rounded-3xl bg-white dark:bg-gray-800 border border-gray-200 dark:border-gray-700">
        ...
        <div className="grid grid-cols-1 gap-4">
          {filteredTasks.map((task) => (
            <div
              key={task.id}
              className="rounded-3xl p-6 bg-white dark:bg-gray-800 border border-gray-200 dark:border-gray-700 hover:border-indigo-200 dark:hover:border-indigo-800 transition-all group"
            >
