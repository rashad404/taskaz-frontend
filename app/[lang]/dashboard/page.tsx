...
export default function DashboardPage() {
  ...
  return (
    <div className="">
                  ...
                  <div className="relative rounded-3xl p-8 text-white">
                    <div className="flex items-center gap-6">
                      ...
                      <div className="flex-1">
                        <h3 className="text-2xl font-bold mb-1">Peşəkar Olun</h3>
          ...
          {/* My Tasks */}
          <Link href={getLocalizedPath(locale, '/dashboard/tasks')} className="rounded-3xl p-6 bg-white/80 dark:bg-gray-900/80 backdrop-blur-xl border border-white/30 dark:border-gray-700/30 hover:border-blue-300 dark:hover:border-blue-700 transition-all cursor-pointer group">
          ...
          {/* Applications */}
          <Link href={getLocalizedPath(locale, '/dashboard/applications')} className="rounded-3xl p-6 bg-white/80 dark:bg-gray-900/80 backdrop-blur-xl border border-white/30 dark:border-gray-700/30 hover:border-purple-300 dark:hover:border-purple-700 transition-all cursor-pointer group">
            <div className="flex items-center justify-between mb-4">
          ...
          {/* Messages */}
          <Link href={getLocalizedPath(locale, '/dashboard/messages')} className="rounded-3xl p-6 bg-white/80 dark:bg-gray-900/80 backdrop-blur-xl border border-white/30 dark:border-gray-700/30 hover:border-orange-300 dark:hover:border-orange-700 transition-all cursor-pointer group">
            <div className="flex items-center justify-between mb-4">
